                                ...
                                <div className="loginbox">
                                    <ul className="nav nav-tabs" role="tablist">
                                        <li className="nav-item col-md-6 col-6 w-100">
                                            <div onClick={(e) => GotoTrainer()} className="nav-link text-center" data-toggle="tab" href="#MEMBER">MEMBER</div>
                                        </li>
                                        <li className="nav-item col-md-6 col-6 w-100">
                                            <a className="active nav-link text-center" data-toggle="tab" href="#TRAINER">TRAINER</a>
                                        </li>
                                    </ul>
                                    <div className="tab-content">
                                        <div id="TRAINER" className="container tab-pane active">
                                            <div className="row my-4">
                                                ...
                                                <div className="col-md-12 text-right">
                                                    <Link to={`/trainer/forgotpassword`} className="linktext">FORGOT PASSWORD ?</Link>
                                                </div>
                                                <div className="col-md-12">
                                                    <button onClick={(e) => PostLogin(e)} className="loginbtn mt-4">Login</button>
                                                </div>
                                                <div className="col-md-12 text-center mt-3">
                                                    <span className="text-login">Not registered yet? <Link to="/trainersignup" className="linktext"> Sign Up</Link></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
